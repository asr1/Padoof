<template>   
  <v-system-bar window app :class="{maximized:maximized}" :style="{background: headerColor}">
    <img :src="logoPath" alt="Padoof" width="16" height="16">
    <div class="app-menu-container">
      ...
      <v-menu bottom offset-y min-width="160">
        ...
        <v-list dense class="context-menu">
          <v-list-item link @mouseup="openLink('https://example.com/docs')">
            <v-list-item-title>
    ...
    <v-spacer></v-spacer>
    <span class="app-system-bar-title">{{$route.name + ' - '}}Padoof</span>
    <v-spacer></v-spacer>
